        ...
        <el-row>
          ...
          <el-col :span="2" style="text-align: center">
            ...
            <el-popover ref="bigAvatar" placement="top-start" :title="githubUsername" width="200" trigger="hover">
              ...
              <br />
              <i class="el-icon-location"></i>&emsp;{{ userInfo.location ? userInfo.location : "未填写地址" }}
              <br />
...
export default {
  ...
  data() {
    return {
      ...
      randomIcon: [],
      configuration: {
        githubUsername: "ValenW",
        blogTitle: "Gridsome BLOG",
        blogDescribe: "欢迎来到个人博客。",
        htmlTitle: "Gridsome BLOG",
        fontColor: "#ffffff",
        useBackgroundImage: false,
        backgroundColorLeft: "#2690F9",
        backgroundColorRight: "#FC2D2D",
        audioUrl: "http://music.163.com/song/media/outer/url?id=1470501460.mp3",
        mini: false,
        webSites: [{ name: "v2ex", url: "https://XXXXXXXXXXXXXXXXX" }],
      },
    };
  },
  computed: {
    userInfo() {
      return this.$static.metadata.githubData.viewer;
    },

    // configuration
    githubUsername() {
      return this.configuration.githubUsername;
    },
    blogTitle() {
      return this.configuration.blogTitle;
    },
    blogDescribe() {
      return this.configuration.blogDescribe;
    },
    htmlTitle() {
      return this.configuration.htmlTitle;
    },
    fontColor() {
      return this.configuration.fontColor;
    },
    useBackgroundImage() {
      return this.configuration.useBackgroundImage;
    },
    backgroundColorLeft() {
      return this.configuration.backgroundColorLeft;
    },
    backgroundColorRight() {
      return this.configuration.backgroundColorRight;
    },
    audioUrl() {
      return this.configuration.audioUrl;
    },
    mini() {
      return this.configuration.mini;
    },
    webSites() {
